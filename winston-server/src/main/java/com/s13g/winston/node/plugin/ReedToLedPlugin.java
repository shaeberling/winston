 ...
 */
public class ReedToLedPlugin implements NodePlugin, ReedController.RelayStateChangedListener {
  ...
  public ReedToLedPlugin(HashMap<Integer, Integer> mapping, ReedController reedController,
   ...
   *
   * @param mapping
   *          an even number of integers, representing pairs of (reed,led)
   *          numbers.
